...
contract IDOLMaster is Ownable, ReentrancyGuard {
    ...
    function stakeBUSD(uint256 amount) external nonReentrant {
        ...
        require(statusPage == 1, "Not Open Pre Sale");
    ...
    function redeemIdolD() external nonReentrant {
        require(statusPage == 2, "Not Open Claim");
    ...
    function redeemIdolP() external nonReentrant {
        require(statusPage == 3 || statusPage == 2, "Not Open Claim");
    ...
    function setStatusPage(uint8 status) external onlyOwner {
        statusPage = status;
    }
